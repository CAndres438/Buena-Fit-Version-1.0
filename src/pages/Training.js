      ...
      <header className={classes.content}>
        <div className={classes.content__box}>
          ...
          <p className={classes.content__text}>
            Te mostramos toda nuestra serie de ejercicios. Con un video
            explícativo y una serie de reglas para hacerlos correctamente, junto
            con los errores más frecuentes que se comenten. Eres libre de verlos
            detallamente.
          </p>
        </div>
        <div className={classes.content__filter}>
          <div className={classes.content__filterContent}>
            ...
            <div className={classes.content__filterBox}>
              <div
                onClick={() => setCategoria("superior")}
                className={classes.content__filterIcon}
              />
              <div
                onClick={() => setCategoria("inferior")}
                className={classes.content__filterIcon}
              />
              <div
                onClick={() => setCategoria("core")}
                className={classes.content__filterIcon}
              />
            </div>
