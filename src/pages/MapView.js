...
import { ButtonSecondary, GrayLightTypographyStyled1, GrayTitleStyled } from '../styled/styledComponents'

const MapView = () => {
    const classes = useStyles();
    
    let date = new Date();
    let general = String(date.getDate()).padStart(2, '0') + ' - ' + String(date.getMonth() + 1).padStart(2, '0') + ' - ' + date.getFullYear();
  ...
  return (
    ...
    <GrayLightTypographyStyled1><h2>{general}</h2></GrayLightTypographyStyled1>
    <Typography className={classes.mapView__sidebarHourClock}>{<Countdown/>}</Typography>
    <img className={classes.mapView__sidebarImage} src='https://images.vexels.com/media/users/3/127818/isolated/preview/ef0a89e9b26123b15f64f82712eec701-camion-de-envio-brillante.png'
    alt='Car Delivery'
    />
