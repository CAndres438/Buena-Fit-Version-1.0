        ...
        <div className={classes.competition__container}>
          <div className={classes.competition__boxOne}>
            ...
            <p className={classes.detail__text}>
              Nervios, excitación, ansiedad, pérdida de apetito, estrés,
              insomnio… Como siempre que vamos a enfrentarnos a una situación
              importante para nosotros, los días previos a una competición es
              habitual sentirse alterado física y emocionalmente. Aparte de la
              agitación general que se experimenta, pueden influir otros
              factores como si es la primera vez que competimos o llevamos
              tiempo haciéndolo, la relevancia y el tipo de campeonato al que
              nos enfrentamos y el grado de responsabilidad que implica
              participar en él.
            </p>
            <p className={classes.detail__text}>
              ...
              nuestro sistema nervioso central, por lo que liberarlas lo
              mantendrá activo.
            </p>
            <p className={classes.detail__text}>
              Para rendir al máximo nivel es necesario que el cuerpo esté
              relajado, reposado y que haya recibido las horas de descanso
              básicas para responder durante la prueba.
            </p>
            ...
            <p className={classes.detail__text}>
              Se distinguen tres fases en este proceso, basándose en el
            ...
            <ol className={classes.competition__boxTwoList}>
              ...
              <li className={classes.competition__boxTwoLi}>
                Finalmente, se pasa a la fase de supercompensación, en la que
                los niveles energéticos y hormonales han subido por encima de la
                curva normal fisiológica y encontramos nuestra mayor capacidad
                de rendimiento. La competición deberá producirse en ese mismo
                momento, por lo que debemos saber la magnitud de la carga en
                volumen e intensidad y aplicarla en el momento justo para que
                nos dé tiempo a recuperar, adaptarnos y mejorar el día clave.
              </li>
            </ol>
          </div>
          <div className={classes.competition__boxTwo}>
            ...
            <img
              ...
              src="https://cdn.pixabay.com/photo/2020/09/27/03/38/woman-5605529_1280.jpg"
              alt="Article Banner"
            />
